...
const templates: Record<ValidLocale, SEOTemplates> = {
  ...
  'zh-TW': {
    title: {
      length: '{type}單位換算器 - {units}線上轉換工具',
      area: '{type}單位換算器 - {units}線上轉換',
      volume: '{type}單位換算器 - {units}快速換算',
      data: '{type}單位換算器 - {units}資料轉換',
      time: '{type}單位換算器 - {units}時間轉換',
      weight: '{type}單位換算器 - {units}重量轉換',
      temperature: '{type}單位換算器 - {units}溫度轉換',
      speed: '{type}單位換算器 - {units}速度轉換',
      angle: '{type}單位換算器 - {units}角度轉換',
      pressure: '{type}單位換算器 - {units}壓力轉換',
      power: '{type}單位換算器 - {units}功率轉換',
      energy: '{type}單位換算器 - {units}能量轉換',
      force: '{type}單位換算器 - {units}力轉換',
      density: '{type}單位換算器 - {units}密度轉換',
      flow: '{type}單位換算器 - {units}流量轉換',
      torque: '{type}單位換算器 - {units}扭力轉換',
      data_rate: '{type}單位換算器 - {units}資料速率轉換',
      cooking: '{type}單位換算器 - {units}烹飪轉換',
      numeral: '{type}單位換算器 - {units}數字轉換',
      frequency: '{type}單位換算器 - {units}頻率轉換'
    },
    description: {
      length: '線上{type}單位換算工具。支援{units}等單位互換，適用於{useCases}。提供精確的換算結果！',
      area: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的面積計算！',
      volume: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的體積容量轉換！',
      data: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的資料轉換！',
      time: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的時間轉換！',
      weight: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的重量轉換！',
      temperature: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的溫度轉換！',
      speed: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的速度轉換！',
      angle: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的角度轉換！',
      pressure: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的壓力轉換！',
      power: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的功率轉換！',
      energy: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的能量轉換！',
      force: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的力轉換！',
      density: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的密度轉換！',
      flow: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的流量轉換！',
      torque: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的扭力轉換！',
      data_rate: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的資料速率轉換！',
      cooking: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的烹飪轉換！',
      numeral: '專業{type}單位換算工具。支援{units}等單位轉換，適用於{useCases}。快速準確的數字轉換！',
      frequency: '線上{type}單位換算。支援{units}等單位互換，適用於{useCases}。精確的頻率轉換！'
    },
    keywords: {
      length: ['長度換算', '單位轉換', '線上工具', '公尺', '公分', '英吋'],
      area: ['面積換算', '單位轉換', '線上工具', '平方公尺', '平方英尺'],
      volume: ['體積換算', '容量轉換', '線上工具', '立方公尺', '公升', '加侖'],
      data: ['資料換算', '單位轉換', '線上工具', '位元組', '千位元組', '百萬位元組'],
      time: ['時間換算', '單位轉換', '線上工具', '秒', '分鐘', '小時'],
      weight: ['重量換算', '單位轉換', '線上工具', '公斤', '公克', '磅'],
      temperature: ['溫度換算', '單位轉換', '線上工具', '攝氏度', '華氏度', '開爾文'],
      ...
      torque: ['扭力換算', '單位轉換', '線上工具', '牛頓·公尺', '公斤·公尺'],
      data_rate: ['資料速率換算', '單位轉換', '線上工具', '位元/秒', '位元組/秒'],
      cooking: ['烹飪換算', '單位轉換', '線上工具', '杯', '匙', '毫升'],
      numeral: ['數字換算', '單位轉換', '線上工具', '十進位', '二進位', '十六進位'],
      frequency: ['頻率換算', '單位轉換', '線上工具', '赫茲', '千赫', '兆赫']
    }
  }
};
