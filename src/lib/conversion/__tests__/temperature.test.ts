...
describe('Temperature Conversion', () => {
  ...
  describe('Basic Temperature Scales', () => {
    ...
    test('celsius to fahrenheit', () => {
      ...
      expect(result.value).toBeCloseTo(212, 2)
  ...
  describe('Special Temperature Points', () => {
    ...
    test('room temperature', () => {
      ...
      expect(result.value).toBeCloseTo(68, 2)
      expect(result.unit).toBe('fahrenheit')
    })
  })
  ...
  describe('Meteorological Temperature Units', () => {
    test('meteorological celsius to fahrenheit', () => {
      const result = convert('temperature', 30, 'celsius_meteorological', 'fahrenheit_meteorological')
      expect(result.value).toBeCloseTo(86, 2)
      expect(result.unit).toBe('fahrenheit_meteorological')
    })

    test('meteorological fahrenheit to celsius', () => {
      const result = convert('temperature', 86, 'fahrenheit_meteorological', 'celsius_meteorological')
      expect(result.value).toBeCloseTo(30, 2)
      expect(result.unit).toBe('celsius_meteorological')
    })
  })
  ...
  describe('Industrial Temperature Units', () => {
    test('industrial celsius to fahrenheit', () => {
      const result = convert('temperature', 150, 'celsius_industrial', 'fahrenheit_industrial')
      expect(result.value).toBeCloseTo(302, 2)
      expect(result.unit).toBe('fahrenheit_industrial')
    })

    test('industrial fahrenheit to celsius', () => {
      const result = convert('temperature', 302, 'fahrenheit_industrial', 'celsius_industrial')
      expect(result.value).toBeCloseTo(150, 2)
      expect(result.unit).toBe('celsius_industrial')
    })
  })
  ...
  describe('Cross-Type Conversions', () => {
    test('meteorological to industrial celsius', () => {
      const result = convert('temperature', 25, 'celsius_meteorological', 'celsius_industrial')
      expect(result.value).toBeCloseTo(25, 2)
      expect(result.unit).toBe('celsius_industrial')
    })

    test('industrial to basic fahrenheit', () => {
      const result = convert('temperature', 451, 'fahrenheit_industrial', 'fahrenheit')
      expect(result.value).toBeCloseTo(451, 2)
      expect(result.unit).toBe('fahrenheit')
    })
  })
